...
},{"process":"pxTL"}],"BQVr":[function(require,module,exports) {
"use strict";
...
var Model = /*#__PURE__*/function (_EventBus) {
  ...
  function Model(options) {
    ...
    _this.properties = ['data', 'create', 'delete', 'update', 'read'];

    _this.properties.forEach(function (key) {
      if (key in options) {
...
var _default = Model;
exports.default = _default;
},{"./EventBus.js":"BQVr"}],"SFHW":[function(require,module,exports) {
"use strict";
...
var View = /*#__PURE__*/function (_EventBus) {
  ...
  function View(options) {
    ...
    _this = _super.call(this);
    Object.assign(_assertThisInitialized(_this), options); // {el, html, render, data, events, eventBus}

    _this.container = (0, _jquery.default)(_this.el);

    _this.render(_this.data);

    _this.autoBindEvents();

    _this.on('model:updated', function () {
      _this.render(_this.data);
    });
...
var _default = View;
exports.default = _default;
},{"jquery":"juYr","./EventBus.js":"BQVr"}],"US5u":[function(require,module,exports) {
"use strict";
...
var init = function init(el) {
  new _View.default({
    ...
    render: function render(data) {
      ...
      (0, _jquery.default)(this.html.replace('{{n}}', data.n)).appendTo(this.container);
    },
    data: model.data,
    events: {
      'click #add': 'add',
...
var _default = init;
exports.default = _default;
},{"./app1.css":"KmRI","jquery":"juYr","./base/Model.js":"wYwp","./base/View.js":"SFHW","./base/EventBus.js":"BQVr"}],"vZ5o":[function(require,module,exports) {
"use strict";
...
var _default = init;
exports.default = _default;
},{"./app2.css":"KmRI","jquery":"juYr","./base/Model.js":"wYwp","./base/View.js":"SFHW","./base/EventBus.js":"BQVr"}],"y8lT":[function(require,module,exports) {
"use strict";
...
//# sourceMappingURL=main.9dd5f942.js.map